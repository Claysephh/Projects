    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Authenticate(LoginUser userParam)
        {
            ...
            if (user != null && passwordHasher.VerifyHashMatch(user.PasswordHash, userParam.Password, user.Salt))
            {
                ...
                List<int> wineries = userDao.GetWineryIdsFromOwnerId(user.UserId);
                // Create a ReturnUser object to return to the client
                LoginResponse retUser = new LoginResponse() { User = new ReturnUser() { UserId = user.UserId, Username = user.Username, Role = user.Role }, Token = token, wineries = wineries };
